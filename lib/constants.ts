 ...
 */
export const APP_NAME: string = 'Blink';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Social prediction markets on Farcaster';
...
export const BASE_ACCOUNT_CONFIG = {
  // Base Account app configuration
  appName: APP_NAME,
  ...
  paymasterUrls: {
    ...
    cdp: 'https://paymaster.coinbase.com',
    // Add other paymaster URLs as needed
  },
  
  // ERC20 token configuration for gas payments
  acceptedTokens: {
    USDC: {
