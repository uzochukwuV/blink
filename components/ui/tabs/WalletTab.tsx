...
import { BaseAccountButton } from "../BaseAccountButton";
  ...
  return (
    <div className="p-4 pb-24">
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="bg-card rounded-lg p-4 border border-borderSubtle">
          <h3 className="text-lg font-semibold text-textPrimary mb-3">Base Account</h3>
          <p className="text-textSecondary text-sm mb-4">
            Sign in with Base Account for smart wallet features and gasless transactions.
          </p>
          <BaseAccountButton
            onSuccess={(result) => {
              console.log('Base Account auth success:', result);
        ...
        <div className="bg-card rounded-lg p-4 border border-borderSubtle">
          <h3 className="text-lg font-semibold text-textPrimary mb-3">Connect Wallet</h3>
